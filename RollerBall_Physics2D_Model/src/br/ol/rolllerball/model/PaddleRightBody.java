...
/**
 * PaddleRightBody class.
 * 
 * @author Leonardo Ono (ono.leo@gmail.com)
 */
public class PaddleRightBody extends RigidBody {
    ...
    public PaddleRightBody(String name, RollerBallGameModel model, double pivotX, double pivotY, int side) {
