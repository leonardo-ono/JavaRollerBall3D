 ...
 */
public class TargetBody extends RigidBody {
    
    protected RollerBallGameModel model;
    protected double pivotX;
    protected double pivotY;
    
    public TargetBody(String name, RollerBallGameModel model, double x1, double y1, double x2, double y2) {
    ...
    public void onCollisionEnter(RigidBody rb, Contact contact) {
        model.addScore(ScoreTable.TARGET);
        setVisible(false);
