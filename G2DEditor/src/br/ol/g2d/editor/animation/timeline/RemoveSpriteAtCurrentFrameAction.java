 ...
 */
public class RemoveSpriteAtCurrentFrameAction extends ActionPanel<AnimationTimeLinePanel>  {

    protected G2DContext context;
    
    public RemoveSpriteAtCurrentFrameAction(AnimationTimeLinePanel panel, G2DContext context) {
        super(panel);
