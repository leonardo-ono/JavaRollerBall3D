 ...
 */
public class SetSpriteAtCurrentFrameAction extends ActionPanel<AnimationTimeLinePanel>  {

    protected G2DContext context;
    protected Point newPosition = new Point();
    
    public SetSpriteAtCurrentFrameAction(AnimationTimeLinePanel panel, G2DContext context) {
        super(panel);
