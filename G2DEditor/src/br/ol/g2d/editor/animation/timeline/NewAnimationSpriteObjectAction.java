...
/**
 * NewAnimationSpriteObjectAction class.
 * 
 * @author Leonardo Ono (ono.leo@gmail.com)
 */
public class NewAnimationSpriteObjectAction extends ActionPanel<AnimationTimeLinePanel>  {

    protected G2DContext context;
    protected Point newPosition = new Point();
    
    public NewAnimationSpriteObjectAction(AnimationTimeLinePanel panel, G2DContext context) {
        super(panel);
