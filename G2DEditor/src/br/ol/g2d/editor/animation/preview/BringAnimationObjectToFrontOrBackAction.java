 ...
 */
public class BringAnimationObjectToFrontOrBackAction extends ActionPanel<AnimationPreviewPanel>  {

    protected G2DContext context;
    
    public BringAnimationObjectToFrontOrBackAction(AnimationPreviewPanel panel, G2DContext context) {
        super(panel);
